...
ifeq (${OS},Darwin)
    ...
    PROTOC_HASH           ?= ab11029340de61bb707a4d564ceeb580d31436f5466fad2194c91beb040aa828
else ifeq (${OS},Linux)
    PROTOC_URL            ?= https://github.com/protocolbuffers/protobuf/releases/download/v${PROTOC_VERSION}/protoc-${PROTOC_VERSION}-linux-x86_64.zip
    PROTOC_HASH           ?= b9ff821d2a4f9e9943dc2a13e6a76d99c7472dac46ddd3718a3a4c3b877c044a
endif
