...
func (*SSHUploadPackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ssh_3a8eb71c29bb333e, []int{0}
}
...
func (*SSHUploadPackResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ssh_3a8eb71c29bb333e, []int{1}
}
...
func (*SSHReceivePackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ssh_3a8eb71c29bb333e, []int{2}
}
...
func (*SSHReceivePackResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ssh_3a8eb71c29bb333e, []int{3}
}
...
func (*SSHUploadArchiveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ssh_3a8eb71c29bb333e, []int{4}
}
...
func (*SSHUploadArchiveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ssh_3a8eb71c29bb333e, []int{5}
}
...
func init() { proto.RegisterFile("ssh.proto", fileDescriptor_ssh_3a8eb71c29bb333e) }

var fileDescriptor_ssh_3a8eb71c29bb333e = []byte{
	// 502 bytes of a gzipped FileDescriptorProto
	,
}
