...
In preparation for Gitaly Clusters, we are now requiring all RPC's to be annotated
...
being modified by the operation. This is needed by Praefect (Gitaly Clusters) in
