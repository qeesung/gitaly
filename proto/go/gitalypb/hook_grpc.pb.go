...
func (c *hookServiceClient) PreReceiveHook(ctx context.Context, opts ...grpc.CallOption) (HookService_PreReceiveHookClient, error) {
	...
	x := &hookServicePreReceiveHookClient{ClientStream: stream}
	return x, nil
}
...
func (c *hookServiceClient) PostReceiveHook(ctx context.Context, opts ...grpc.CallOption) (HookService_PostReceiveHookClient, error) {
	...
	x := &hookServicePostReceiveHookClient{ClientStream: stream}
	return x, nil
}
...
func (c *hookServiceClient) UpdateHook(ctx context.Context, in *UpdateHookRequest, opts ...grpc.CallOption) (HookService_UpdateHookClient, error) {
	...
	x := &hookServiceUpdateHookClient{ClientStream: stream}
...
func (c *hookServiceClient) ReferenceTransactionHook(ctx context.Context, opts ...grpc.CallOption) (HookService_ReferenceTransactionHookClient, error) {
	...
	x := &hookServiceReferenceTransactionHookClient{ClientStream: stream}
	return x, nil
}
...
func (c *hookServiceClient) ProcReceiveHook(ctx context.Context, opts ...grpc.CallOption) (HookService_ProcReceiveHookClient, error) {
	...
	x := &hookServiceProcReceiveHookClient{ClientStream: stream}
	return x, nil
}
...
func _HookService_PreReceiveHook_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HookServiceServer).PreReceiveHook(&hookServicePreReceiveHookServer{ServerStream: stream})
}
...
func _HookService_PostReceiveHook_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HookServiceServer).PostReceiveHook(&hookServicePostReceiveHookServer{ServerStream: stream})
}
...
func _HookService_UpdateHook_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HookServiceServer).UpdateHook(m, &hookServiceUpdateHookServer{ServerStream: stream})
}
...
func _HookService_ReferenceTransactionHook_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HookServiceServer).ReferenceTransactionHook(&hookServiceReferenceTransactionHookServer{ServerStream: stream})
}
...
func _HookService_ProcReceiveHook_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HookServiceServer).ProcReceiveHook(&hookServiceProcReceiveHookServer{ServerStream: stream})
}
