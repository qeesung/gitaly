...
// Given two commits, return the files changed.
type FindChangedPathsBetweenCommitsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Repository *Repository `protobuf:"bytes,1,opt,name=repository,proto3" json:"repository,omitempty"`
	// "Before" commit to compare
	LeftCommitId string `protobuf:"bytes,2,opt,name=left_commit_id,json=leftCommitId,proto3" json:"left_commit_id,omitempty"`
	// "After" commit to compare
	RightCommitId string `protobuf:"bytes,3,opt,name=right_commit_id,json=rightCommitId,proto3" json:"right_commit_id,omitempty"`
}

func (x *FindChangedPathsBetweenCommitsRequest) Reset() {
	*x = FindChangedPathsBetweenCommitsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *FindChangedPathsBetweenCommitsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindChangedPathsBetweenCommitsRequest) ProtoMessage() {}

func (x *FindChangedPathsBetweenCommitsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_diff_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindChangedPathsBetweenCommitsRequest.ProtoReflect.Descriptor instead.
func (*FindChangedPathsBetweenCommitsRequest) Descriptor() ([]byte, []int) {
	return file_diff_proto_rawDescGZIP(), []int{15}
}

func (x *FindChangedPathsBetweenCommitsRequest) GetRepository() *Repository {
	if x != nil {
		return x.Repository
	}
	return nil
...
func (x *FindChangedPathsBetweenCommitsRequest) GetLeftCommitId() string {
	if x != nil {
		return x.LeftCommitId
	}
	return ""
...
func (x *FindChangedPathsBetweenCommitsRequest) GetRightCommitId() string {
	if x != nil {
		return x.RightCommitId
	}
	return ""
...
// Returns a list of files that have been changed between the commits given
type FindChangedPathsBetweenCommitsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// List of paths that have been changed
	Paths []*ChangedPaths `protobuf:"bytes,1,rep,name=paths,proto3" json:"paths,omitempty"`
}

func (x *FindChangedPathsBetweenCommitsResponse) Reset() {
	*x = FindChangedPathsBetweenCommitsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *FindChangedPathsBetweenCommitsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindChangedPathsBetweenCommitsResponse) ProtoMessage() {}

func (x *FindChangedPathsBetweenCommitsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_diff_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindChangedPathsBetweenCommitsResponse.ProtoReflect.Descriptor instead.
func (*FindChangedPathsBetweenCommitsResponse) Descriptor() ([]byte, []int) {
	return file_diff_proto_rawDescGZIP(), []int{16}
}

func (x *FindChangedPathsBetweenCommitsResponse) GetPaths() []*ChangedPaths {
	if x != nil {
		return x.Paths
	}
	return nil
...
var file_diff_proto_rawDesc = []byte{
	...
	0x43, 0x4f, 0x50, 0x49, 0x45, 0x44, 0x10, 0x04, 0x22, 0xaf, 0x01, 0x0a, 0x25, 0x46, 0x69, 0x6e,
	0x64, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x64, 0x50, 0x61, 0x74, 0x68, 0x73, 0x42, 0x65, 0x74,
	0x77, 0x65, 0x65, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x52, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x24, 0x0a, 0x0e,
	...
	0x68, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x49, 0x64, 0x22, 0x54, 0x0a, 0x26, 0x46, 0x69,
	0x6e, 0x64, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x64, 0x50, 0x61, 0x74, 0x68, 0x73, 0x42, 0x65,
	0x74, 0x77, 0x65, 0x65, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70,
	...
	0x32, 0xf6, 0x04, 0x0a, 0x0b, 0x44, 0x69, 0x66, 0x66, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	,
...
var file_diff_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_diff_proto_goTypes = []interface{}{
	...
	(*FindChangedPathsBetweenCommitsRequest)(nil),  // 17: gitaly.FindChangedPathsBetweenCommitsRequest
...
var file_diff_proto_depIdxs = []int32{
	19, // 0: gitaly.CommitDiffRequest.repository:type_name -> gitaly.Repository
	0,  // 1: gitaly.CommitDiffRequest.diff_mode:type_name -> gitaly.CommitDiffRequest.DiffMode
	19, // 2: gitaly.CommitDeltaRequest.repository:type_name -> gitaly.Repository
	5,  // 3: gitaly.CommitDeltaResponse.deltas:type_name -> gitaly.CommitDelta
	19, // 4: gitaly.RawDiffRequest.repository:type_name -> gitaly.Repository
	19, // 5: gitaly.RawPatchRequest.repository:type_name -> gitaly.Repository
	19, // 6: gitaly.DiffStatsRequest.repository:type_name -> gitaly.Repository
	12, // 7: gitaly.DiffStatsResponse.stats:type_name -> gitaly.DiffStats
	19, // 8: gitaly.FindChangedPathsRequest.repository:type_name -> gitaly.Repository
	...
	19, // 11: gitaly.FindChangedPathsBetweenCommitsRequest.repository:type_name -> gitaly.Repository
	16, // 12: gitaly.FindChangedPathsBetweenCommitsResponse.paths:type_name -> gitaly.ChangedPaths
	2,  // 13: gitaly.DiffService.CommitDiff:input_type -> gitaly.CommitDiffRequest
	4,  // 14: gitaly.DiffService.CommitDelta:input_type -> gitaly.CommitDeltaRequest
	7,  // 15: gitaly.DiffService.RawDiff:input_type -> gitaly.RawDiffRequest
	9,  // 16: gitaly.DiffService.RawPatch:input_type -> gitaly.RawPatchRequest
	11, // 17: gitaly.DiffService.DiffStats:input_type -> gitaly.DiffStatsRequest
	14, // 18: gitaly.DiffService.FindChangedPaths:input_type -> gitaly.FindChangedPathsRequest
	17, // 19: gitaly.DiffService.FindChangedPathsBetweenCommits:input_type -> gitaly.FindChangedPathsBetweenCommitsRequest
	...
	18, // 26: gitaly.DiffService.FindChangedPathsBetweenCommits:output_type -> gitaly.FindChangedPathsBetweenCommitsResponse
...
func file_diff_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_diff_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindChangedPathsBetweenCommitsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_diff_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindChangedPathsBetweenCommitsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
