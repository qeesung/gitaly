...
func (*BackupRepositoryResponse_SkippedError) Descriptor() ([]byte, []int) {
	return file_repository_proto_rawDescGZIP(), []int{78, 0}
}
...
var file_repository_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xc6, 0x1e, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79,
	...
	0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x03, 0x12, 0x5d, 0x0a, 0x10, 0x42, 0x61, 0x63, 0x6b, 0x75,
	0x70, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x1f, 0x2e, 0x67, 0x69,
	...
	0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x06,
	0xfa, 0x97, 0x28, 0x02, 0x08, 0x02, 0x12, 0x60, 0x0a, 0x11, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x20, 0x2e, 0x67, 0x69,
	...
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x01, 0x12, 0x60, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x46,
	0x69, 0x6c, 0x65, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x20, 0x2e,
	...
	0x21, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x47, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x65,
...
var file_repository_proto_goTypes = []interface{}{
	...
	(*BackupRepositoryRequest)(nil),                 // 80: gitaly.BackupRepositoryRequest
	(*BackupRepositoryResponse)(nil),                // 81: gitaly.BackupRepositoryResponse
	(*RestoreRepositoryRequest)(nil),                // 82: gitaly.RestoreRepositoryRequest
	(*RestoreRepositoryResponse)(nil),               // 83: gitaly.RestoreRepositoryResponse
	(*GetFileAttributesRequest)(nil),                // 84: gitaly.GetFileAttributesRequest
	(*GetFileAttributesResponse)(nil),               // 85: gitaly.GetFileAttributesResponse
	...
	(*BackupRepositoryResponse_SkippedError)(nil),   // 89: gitaly.BackupRepositoryResponse.SkippedError
	(*RestoreRepositoryResponse_SkippedError)(nil),  // 90: gitaly.RestoreRepositoryResponse.SkippedError
	(*GetFileAttributesResponse_AttributeInfo)(nil), // 91: gitaly.GetFileAttributesResponse.AttributeInfo
...
var file_repository_proto_depIdxs = []int32{
	...
	92, // 5: gitaly.ObjectsSizeRequest.repository:type_name -> gitaly.Repository
	92, // 6: gitaly.ObjectFormatRequest.repository:type_name -> gitaly.Repository
	93, // 7: gitaly.ObjectFormatResponse.format:type_name -> gitaly.ObjectFormat
	92, // 8: gitaly.ApplyGitattributesRequest.repository:type_name -> gitaly.Repository
	92, // 9: gitaly.FetchBundleRequest.repository:type_name -> gitaly.Repository
	...
	93, // 13: gitaly.CreateRepositoryRequest.object_format:type_name -> gitaly.ObjectFormat
	92, // 14: gitaly.GetArchiveRequest.repository:type_name -> gitaly.Repository
	0,  // 15: gitaly.GetArchiveRequest.format:type_name -> gitaly.GetArchiveRequest.Format
	92, // 16: gitaly.HasLocalBranchesRequest.repository:type_name -> gitaly.Repository
	92, // 17: gitaly.FetchSourceBranchRequest.repository:type_name -> gitaly.Repository
	92, // 18: gitaly.FetchSourceBranchRequest.source_repository:type_name -> gitaly.Repository
	92, // 19: gitaly.FsckRequest.repository:type_name -> gitaly.Repository
	92, // 20: gitaly.WriteRefRequest.repository:type_name -> gitaly.Repository
	92, // 21: gitaly.FindMergeBaseRequest.repository:type_name -> gitaly.Repository
	92, // 22: gitaly.CreateForkRequest.repository:type_name -> gitaly.Repository
	92, // 23: gitaly.CreateForkRequest.source_repository:type_name -> gitaly.Repository
	92, // 24: gitaly.CreateRepositoryFromURLRequest.repository:type_name -> gitaly.Repository
	92, // 25: gitaly.CreateBundleRequest.repository:type_name -> gitaly.Repository
	92, // 26: gitaly.CreateBundleFromRefListRequest.repository:type_name -> gitaly.Repository
	92, // 27: gitaly.GetConfigRequest.repository:type_name -> gitaly.Repository
	92, // 28: gitaly.RestoreCustomHooksRequest.repository:type_name -> gitaly.Repository
	92, // 29: gitaly.SetCustomHooksRequest.repository:type_name -> gitaly.Repository
	92, // 30: gitaly.BackupCustomHooksRequest.repository:type_name -> gitaly.Repository
	92, // 31: gitaly.GetCustomHooksRequest.repository:type_name -> gitaly.Repository
	92, // 32: gitaly.CreateRepositoryFromBundleRequest.repository:type_name -> gitaly.Repository
	92, // 33: gitaly.FindLicenseRequest.repository:type_name -> gitaly.Repository
	92, // 34: gitaly.GetInfoAttributesRequest.repository:type_name -> gitaly.Repository
	92, // 35: gitaly.CalculateChecksumRequest.repository:type_name -> gitaly.Repository
	92, // 36: gitaly.GetSnapshotRequest.repository:type_name -> gitaly.Repository
	92, // 37: gitaly.CreateRepositoryFromSnapshotRequest.repository:type_name -> gitaly.Repository
	92, // 38: gitaly.GetRawChangesRequest.repository:type_name -> gitaly.Repository
	88, // 39: gitaly.GetRawChangesResponse.raw_changes:type_name -> gitaly.GetRawChangesResponse.RawChange
	92, // 40: gitaly.SearchFilesByNameRequest.repository:type_name -> gitaly.Repository
	92, // 41: gitaly.SearchFilesByContentRequest.repository:type_name -> gitaly.Repository
	92, // 42: gitaly.GetObjectDirectorySizeRequest.repository:type_name -> gitaly.Repository
	92, // 43: gitaly.RemoveRepositoryRequest.repository:type_name -> gitaly.Repository
	...
	92, // 49: gitaly.BackupRepositoryRequest.repository:type_name -> gitaly.Repository
	92, // 50: gitaly.BackupRepositoryRequest.vanity_repository:type_name -> gitaly.Repository
	92, // 51: gitaly.RestoreRepositoryRequest.repository:type_name -> gitaly.Repository
	92, // 52: gitaly.RestoreRepositoryRequest.vanity_repository:type_name -> gitaly.Repository
	92, // 53: gitaly.GetFileAttributesRequest.repository:type_name -> gitaly.Repository
	91, // 54: gitaly.GetFileAttributesResponse.attribute_infos:type_name -> gitaly.GetFileAttributesResponse.AttributeInfo
	...
	9,  // 59: gitaly.RepositoryService.ObjectsSize:input_type -> gitaly.ObjectsSizeRequest
	11, // 60: gitaly.RepositoryService.ObjectFormat:input_type -> gitaly.ObjectFormatRequest
	13, // 61: gitaly.RepositoryService.ApplyGitattributes:input_type -> gitaly.ApplyGitattributesRequest
	17, // 62: gitaly.RepositoryService.FetchRemote:input_type -> gitaly.FetchRemoteRequest
	19, // 63: gitaly.RepositoryService.CreateRepository:input_type -> gitaly.CreateRepositoryRequest
	21, // 64: gitaly.RepositoryService.GetArchive:input_type -> gitaly.GetArchiveRequest
	23, // 65: gitaly.RepositoryService.HasLocalBranches:input_type -> gitaly.HasLocalBranchesRequest
	25, // 66: gitaly.RepositoryService.FetchSourceBranch:input_type -> gitaly.FetchSourceBranchRequest
	27, // 67: gitaly.RepositoryService.Fsck:input_type -> gitaly.FsckRequest
	29, // 68: gitaly.RepositoryService.WriteRef:input_type -> gitaly.WriteRefRequest
	31, // 69: gitaly.RepositoryService.FindMergeBase:input_type -> gitaly.FindMergeBaseRequest
	33, // 70: gitaly.RepositoryService.CreateFork:input_type -> gitaly.CreateForkRequest
	35, // 71: gitaly.RepositoryService.CreateRepositoryFromURL:input_type -> gitaly.CreateRepositoryFromURLRequest
	37, // 72: gitaly.RepositoryService.CreateBundle:input_type -> gitaly.CreateBundleRequest
	39, // 73: gitaly.RepositoryService.CreateBundleFromRefList:input_type -> gitaly.CreateBundleFromRefListRequest
	15, // 74: gitaly.RepositoryService.FetchBundle:input_type -> gitaly.FetchBundleRequest
	51, // 75: gitaly.RepositoryService.CreateRepositoryFromBundle:input_type -> gitaly.CreateRepositoryFromBundleRequest
	41, // 76: gitaly.RepositoryService.GetConfig:input_type -> gitaly.GetConfigRequest
	53, // 77: gitaly.RepositoryService.FindLicense:input_type -> gitaly.FindLicenseRequest
	55, // 78: gitaly.RepositoryService.GetInfoAttributes:input_type -> gitaly.GetInfoAttributesRequest
	57, // 79: gitaly.RepositoryService.CalculateChecksum:input_type -> gitaly.CalculateChecksumRequest
	59, // 80: gitaly.RepositoryService.GetSnapshot:input_type -> gitaly.GetSnapshotRequest
	61, // 81: gitaly.RepositoryService.CreateRepositoryFromSnapshot:input_type -> gitaly.CreateRepositoryFromSnapshotRequest
	63, // 82: gitaly.RepositoryService.GetRawChanges:input_type -> gitaly.GetRawChangesRequest
	67, // 83: gitaly.RepositoryService.SearchFilesByContent:input_type -> gitaly.SearchFilesByContentRequest
	65, // 84: gitaly.RepositoryService.SearchFilesByName:input_type -> gitaly.SearchFilesByNameRequest
	...
	70, // 89: gitaly.RepositoryService.GetObjectDirectorySize:input_type -> gitaly.GetObjectDirectorySizeRequest
	72, // 90: gitaly.RepositoryService.RemoveRepository:input_type -> gitaly.RemoveRepositoryRequest
	...
	80, // 94: gitaly.RepositoryService.BackupRepository:input_type -> gitaly.BackupRepositoryRequest
	82, // 95: gitaly.RepositoryService.RestoreRepository:input_type -> gitaly.RestoreRepositoryRequest
	84, // 96: gitaly.RepositoryService.GetFileAttributes:input_type -> gitaly.GetFileAttributesRequest
	4,  // 97: gitaly.RepositoryService.RepositoryExists:output_type -> gitaly.RepositoryExistsResponse
	6,  // 98: gitaly.RepositoryService.RepositorySize:output_type -> gitaly.RepositorySizeResponse
	8,  // 99: gitaly.RepositoryService.RepositoryInfo:output_type -> gitaly.RepositoryInfoResponse
	10, // 100: gitaly.RepositoryService.ObjectsSize:output_type -> gitaly.ObjectsSizeResponse
	12, // 101: gitaly.RepositoryService.ObjectFormat:output_type -> gitaly.ObjectFormatResponse
	14, // 102: gitaly.RepositoryService.ApplyGitattributes:output_type -> gitaly.ApplyGitattributesResponse
	18, // 103: gitaly.RepositoryService.FetchRemote:output_type -> gitaly.FetchRemoteResponse
	20, // 104: gitaly.RepositoryService.CreateRepository:output_type -> gitaly.CreateRepositoryResponse
	22, // 105: gitaly.RepositoryService.GetArchive:output_type -> gitaly.GetArchiveResponse
	24, // 106: gitaly.RepositoryService.HasLocalBranches:output_type -> gitaly.HasLocalBranchesResponse
	26, // 107: gitaly.RepositoryService.FetchSourceBranch:output_type -> gitaly.FetchSourceBranchResponse
	28, // 108: gitaly.RepositoryService.Fsck:output_type -> gitaly.FsckResponse
	30, // 109: gitaly.RepositoryService.WriteRef:output_type -> gitaly.WriteRefResponse
	32, // 110: gitaly.RepositoryService.FindMergeBase:output_type -> gitaly.FindMergeBaseResponse
	34, // 111: gitaly.RepositoryService.CreateFork:output_type -> gitaly.CreateForkResponse
	36, // 112: gitaly.RepositoryService.CreateRepositoryFromURL:output_type -> gitaly.CreateRepositoryFromURLResponse
	38, // 113: gitaly.RepositoryService.CreateBundle:output_type -> gitaly.CreateBundleResponse
	40, // 114: gitaly.RepositoryService.CreateBundleFromRefList:output_type -> gitaly.CreateBundleFromRefListResponse
	16, // 115: gitaly.RepositoryService.FetchBundle:output_type -> gitaly.FetchBundleResponse
	52, // 116: gitaly.RepositoryService.CreateRepositoryFromBundle:output_type -> gitaly.CreateRepositoryFromBundleResponse
	42, // 117: gitaly.RepositoryService.GetConfig:output_type -> gitaly.GetConfigResponse
	54, // 118: gitaly.RepositoryService.FindLicense:output_type -> gitaly.FindLicenseResponse
	56, // 119: gitaly.RepositoryService.GetInfoAttributes:output_type -> gitaly.GetInfoAttributesResponse
	58, // 120: gitaly.RepositoryService.CalculateChecksum:output_type -> gitaly.CalculateChecksumResponse
	60, // 121: gitaly.RepositoryService.GetSnapshot:output_type -> gitaly.GetSnapshotResponse
	62, // 122: gitaly.RepositoryService.CreateRepositoryFromSnapshot:output_type -> gitaly.CreateRepositoryFromSnapshotResponse
	64, // 123: gitaly.RepositoryService.GetRawChanges:output_type -> gitaly.GetRawChangesResponse
	68, // 124: gitaly.RepositoryService.SearchFilesByContent:output_type -> gitaly.SearchFilesByContentResponse
	66, // 125: gitaly.RepositoryService.SearchFilesByName:output_type -> gitaly.SearchFilesByNameResponse
	45, // 126: gitaly.RepositoryService.RestoreCustomHooks:output_type -> gitaly.RestoreCustomHooksResponse
	46, // 127: gitaly.RepositoryService.SetCustomHooks:output_type -> gitaly.SetCustomHooksResponse
	49, // 128: gitaly.RepositoryService.BackupCustomHooks:output_type -> gitaly.BackupCustomHooksResponse
	50, // 129: gitaly.RepositoryService.GetCustomHooks:output_type -> gitaly.GetCustomHooksResponse
	71, // 130: gitaly.RepositoryService.GetObjectDirectorySize:output_type -> gitaly.GetObjectDirectorySizeResponse
	73, // 131: gitaly.RepositoryService.RemoveRepository:output_type -> gitaly.RemoveRepositoryResponse
	75, // 132: gitaly.RepositoryService.ReplicateRepository:output_type -> gitaly.ReplicateRepositoryResponse
	77, // 133: gitaly.RepositoryService.OptimizeRepository:output_type -> gitaly.OptimizeRepositoryResponse
	79, // 134: gitaly.RepositoryService.PruneUnreachableObjects:output_type -> gitaly.PruneUnreachableObjectsResponse
	81, // 135: gitaly.RepositoryService.BackupRepository:output_type -> gitaly.BackupRepositoryResponse
	83, // 136: gitaly.RepositoryService.RestoreRepository:output_type -> gitaly.RestoreRepositoryResponse
	85, // 137: gitaly.RepositoryService.GetFileAttributes:output_type -> gitaly.GetFileAttributesResponse
