...
type UpdateRemoteMirrorRequest struct {
	...
	DeleteDivergentRefs  bool        `protobuf:"varint,6,opt,name=delete_divergent_refs,json=deleteDivergentRefs,proto3" json:"delete_divergent_refs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *UpdateRemoteMirrorRequest) GetDeleteDivergentRefs() bool {
	if m != nil {
		return m.DeleteDivergentRefs
	}
	return false
}
...
var fileDescriptor_eefc82927d57d89b = []byte{
	...
	,
}
