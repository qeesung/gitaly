...
func (c *cleanupServiceClient) ApplyBfgObjectMapStream(ctx context.Context, opts ...grpc.CallOption) (CleanupService_ApplyBfgObjectMapStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &CleanupService_ServiceDesc.Streams[0], CleanupService_ApplyBfgObjectMapStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *cleanupServiceClient) RewriteHistory(ctx context.Context, opts ...grpc.CallOption) (CleanupService_RewriteHistoryClient, error) {
	stream, err := c.cc.NewStream(ctx, &CleanupService_ServiceDesc.Streams[1], CleanupService_RewriteHistory_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
