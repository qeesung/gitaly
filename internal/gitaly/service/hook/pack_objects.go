...
func (s *server) PackObjectsHook(stream gitalypb.HookService_PackObjectsHookServer) error {
	...
	output := func(r readerWriterTo) (int64, error) {
		var n int64
...
func (s *server) packObjectsHook(ctx context.Context, repo *gitalypb.Repository, reqHash proto.Message, args *packObjectsArgs, stdinReader io.Reader, output func(readerWriterTo) (int64, error)) error {
	h := sha256.New()
...
func (s *server) PackObjectsHookStream(ctx context.Context, req *gitalypb.PackObjectsHookStreamRequest) (*emptypb.Empty, error) {
	...
	output := func(rwt readerWriterTo) (int64, error) { return rwt.WriteTo(c) }
