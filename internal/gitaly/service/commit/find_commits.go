...
func streamCommits(getCommits *GetCommits, stream gitalypb.CommitService_FindCommitsServer, trailers, shortStat bool, refs bool) (int, error) {
	ctx := stream.Context()
	commitCounter := 0
...
func getLogCommandSubCmd(req *gitalypb.FindCommitsRequest) (git.Command, int) {
...
func wrapGitLogCmdError(revision []byte, commitCounter int, err error, stderr string) (structError structerr.Error) {
