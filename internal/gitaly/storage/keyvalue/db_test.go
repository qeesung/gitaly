...
func TestNewDBManager(t *testing.T) {
	...
	t.Run("database opener error", func(t *testing.T) {
		opener := DatabaseOpenerFunc(func(log.Logger, string) (Store, error) {
	...
	t.Run("successful initialization", func(t *testing.T) {
		...
		dbMgr, err := NewDBManager(cfg.Storages, DatabaseOpenerFunc(NewBadgerStore), helper.NewNullTickerFactory(), logger)
		require.NoError(t, err)
		require.NotNil(t, dbMgr)
...
func TestDBManager_GetDB(t *testing.T) {
	...
	// Write test for getting an existing storage
...
func TestDBManager_garbageCollection(t *testing.T) {
	...
	dbMgr, err := NewDBManager(
		cfg.Storages,
		DatabaseOpenerFunc(func(logger log.Logger, path string) (Store, error) {
