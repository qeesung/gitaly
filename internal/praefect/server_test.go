...
func TestProxyWrites(t *testing.T) {
	...
	assert.Equal(t, 1, smartHttp0.methodsCalled["PostReceivePack"])
	assert.Equal(t, 1, smartHttp1.methodsCalled["PostReceivePack"])
	assert.Equal(t, 1, smartHttp2.methodsCalled["PostReceivePack"])
}
